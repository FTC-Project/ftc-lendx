...
def render_commands(user: Optional[TelegramUser], role_status: str) -> str:
    ...
    text += "• <code>/balance</code> - Check your FTC, CTT, and XRP token balances\n"
    text += "• <code>/linkbank</code> - Link your bank account for loan applications\n"
...
def render_getting_started() -> str:
    return (
        ...
        "Use <code>/start</code> to begin. You'll need to accept our Terms of Service to create your account.\n\n"
        "<b>Step 2: Complete Registration</b>\n"
        "Use <code>/register</code> to complete your profile:\n"
        ...
        "<b>👉 For Borrowers:</b>\n"
        "1. Link your bank: <code>/linkbank</code>\n"
        "2. Check your credit score: <code>/score</code>\n"
        "3. Apply for a loan: <code>/apply</code>\n\n"
        "<b>👉 For Lenders:</b>\n"
        "1. Buy FTCoin: <code>/buyftc</code>\n"
        "2. Deposit to pool: <code>/deposit</code>\n"
        "3. Earn interest on your deposits\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "💡 <i>Need help? Use <code>/help</code> anytime or browse our FAQs!</i>"
    )
...
def render_borrower_guide() -> str:
    return (
        ...
        "• Complete registration: <code>/register</code>\n"
        "• Link your bank account: <code>/linkbank</code>\n"
        "• Build your credit score: <code>/score</code>\n\n"
        "<b>2. Apply for a Loan</b>\n"
        "• Start application: <code>/apply</code>\n"
        ...
        "• Use <code>/help</code> if you're stuck!"
    )
...
def render_lender_guide() -> str:
    return (
        ...
        "• Buy FTCoin: <code>/buyftc</code>\n"
        "• Convert ZAR to FTC at 1:1 rate\n"
        "• Check balance: <code>/balance</code>\n\n"
        "<b>3. Deposit to Pool</b>\n"
        "• View pool details: <code>/deposit</code>\n"
        ...
        "• Withdraw anytime: <code>/withdraw</code>\n"
        "• No lock-in periods\n"
        "• Convert to ZAR: <code>/offramp</code>\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "<b>💡 Tips for Success</b>\n"
        ...
        "• Use <code>/help</code> for any questions!"
    )
...
def render_ftc_info() -> str:
    return (
        ...
        "• <code>/buyftc [amount]</code> - Buy FTC with ZAR\n"
        "• <code>/offramp [amount]</code> - Sell FTC for ZAR\n\n"
        "<b>📊 Checking Your Balance</b>\n"
        "• <code>/balance</code> - View FTC, CTT, and XRP balances\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
...
def render_loan_process() -> str:
    return (
        ...
        "✓ Complete registration: <code>/register</code>\n"
        "✓ Link your bank account: <code>/linkbank</code>\n"
        "✓ Check your credit score: <code>/score</code>\n\n"
        "<b>2. Start Application</b>\n"
        "• Use command: <code>/apply</code>\n"
        ...
        "• Check loan status: <code>/status</code>"
    )
...
def render_repayment() -> str:
    return (
        ...
        "• Use <code>/status</code> to see:\n"
        "  - Current balance\n"
        "  - Amount repaid\n"
        "  - Next due date\n"
        "  - Final due date\n\n"
        "<b>2. Get FTCoin</b>\n"
        "• If you need FTC: <code>/buyftc [amount]</code>\n"
        "• Check balance: <code>/balance</code>\n\n"
...
def render_pool_deposits() -> str:
    return (
        ...
        "• Buy FTCoin: <code>/buyftc [amount]</code>\n"
        "• Check balance: <code>/balance</code>\n"
        "• Ensure you have XRP for gas fees\n\n"
        "<b>2. View Pool Details</b>\n"
        "• Use: <code>/deposit</code>\n"
        "• Review:\n"
        ...
        "• Track all deposits: <code>/balance</code>\n\n"
        "<b>⚠️ Notes</b>\n"
...
def render_faq_answer(faq_key: str) -> str:
    ...
    faqs = {
        FAQ_WHAT_IS_NKADIME: (
            ...
            "Start with <code>/start</code> to create your account!"
        ),
        FAQ_HOW_TO_START: (
            "🚀 <b>How Do I Get Started?</b>\n\n"
            "<b>Step 1:</b> Use <code>/start</code>\n"
            "• Accept Terms of Service\n"
            "• Create your account\n\n"
            "<b>Step 2:</b> Complete Registration\n"
            "• Use <code>/register</code>\n"
            "• Provide your information\n"
            "• Upload ID photo\n"
            "• Select role (Borrower or Lender)\n\n"
            "<b>Step 3:</b> Choose Your Path\n"
            "• <b>Borrowers:</b> <code>/linkbank</code> → <code>/apply</code>\n"
            "• <b>Lenders:</b> <code>/buyftc</code> → <code>/deposit</code>\n\n"
            "Need help? Use <code>/help</code> anytime!"
        ),
        FAQ_HOW_TO_REGISTER: (
            "📝 <b>How Do I Register?</b>\n\n"
            "Use <code>/register</code> and follow these steps:\n\n"
        ...
        FAQ_HOW_TO_BORROW: (
            ...
            "✓ Bank account linked: <code>/linkbank</code>\n"
            "✓ Credit score checked: <code>/score</code>\n\n"
        ...
        FAQ_HOW_TO_LEND: (
            ...
            "• Buy FTC: <code>/buyftc [amount]</code>\n"
            "• 1 FTC = R1.00\n\n"
        ...
        FAQ_WHAT_IS_FTC: (
            ...
            "<b>Commands:</b>\n"
            "• <code>/buyftc</code> - Buy FTC with ZAR\n"
            "• <code>/offramp</code> - Sell FTC for ZAR\n"
            "• <code>/balance</code> - Check your FTC balance\n\n"
            "FTC makes borrowing and lending simple and safe!"
        ),
        FAQ_HOW_TO_GET_FTC: (
            "💵 <b>How Do I Get FTCoin?</b>\n\n"
            "<b>Method 1: Buy FTC</b>\n"
            "• Use: <code>/buyftc [amount]</code>\n"
            "• Convert ZAR to FTC\n"
            "• Rate: 1 FTC = R1.00\n\n"
            "<b>Method 2: Receive Loan</b>\n"
            "• Apply for loan: <code>/apply</code>\n"
            "• Loan disbursed in FTCoin\n\n"
            "<b>Method 3: Receive Deposit (Lenders)</b>\n"
            "• Withdraw from pool: <code>/withdraw</code>\n"
        ...
        FAQ_REPAYMENT_OPTIONS: (
            ...
            "• Buy FTC: <code>/buyftc [amount]</code>\n"
            "• Check balance: <code>/balance</code>\n\n"
            "<b>📅 Important:</b> Check <code>/status</code> for due dates and balances!"
        ),
        FAQ_LATE_PAYMENTS: (
            ...
            "<b>What to Do:</b>\n"
            "1. Repay as soon as possible: <code>/repay</code>\n"
            "2. Check status: <code>/status</code>\n"
        ...
        FAQ_POOL_SAFETY: (
            ...
            "• Verify transactions: <code>/balance</code>\n"
        ...
        FAQ_CREDIT_SCORE: (
            ...
            "  - Higher loan limits\n"
            "  - Better loan terms\n\n"
            "Check regularly: <code>/score</code>"
        ),
        FAQ_LINK_BANK: (
        ...
        FAQ_SUPPORT: (
            ...
            "• Browse FAQs: <code>/help</code>\n"
            "• Check command descriptions\n"
            "• Review process guides\n\n"
            "<b>Common Commands for Help:</b>\n"
            "• <code>/help</code> - This help center\n"
            "• <code>/status</code> - Check loan status\n"
            "• <code>/balance</code> - View balances\n"
            "• <code>/score</code> - Credit score info\n\n"
            "<b>📚 Help Sections:</b>\n"
            ...
            "• Ensure you're registered: <code>/register</code>\n"
            "• Check role permissions\n\n"
            "<b>💡 Tip:</b> Most questions are answered in the <code>/help</code> menu. "
    ...
    def task(message_data: dict) -> None:
        ...
        if cb == "flow:cancel":
            ...
            reply(
                ...
                "Use <code>/help</code> anytime to get help again!",
                data=data,
                parse_mode="HTML",
            )
            return
