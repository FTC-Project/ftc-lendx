...
class TelegramUserAdmin(admin.ModelAdmin):
    list_display = ("telegram_id","username","first_name","last_name","role","is_active","created_at")
    search_fields = ("telegram_id","username","first_name","last_name","phone_e164","national_id")
...
class TransferAdmin(admin.ModelAdmin):
    list_display = ("sender","recipient","destination_address","amount_drops","status","tx_hash","created_at")
    list_filter = ("status",)
