...
class TelegramUser(models.Model):
    ...
    national_id = models.CharField(max_length=32, null=True, blank=True, db_index=True)  # SA ID (mock)
...
class BotSession(models.Model):
    ...
    user = models.OneToOneField(TelegramUser, on_delete=models.CASCADE, related_name="bot_session")
...
class Notification(models.Model):
    ...
    kind = models.CharField(max_length=32, db_index=True)  # e.g., loan_due, loan_approved
