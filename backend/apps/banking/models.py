...
class Consent(models.Model):
    ...
    user = models.ForeignKey(TelegramUser, on_delete=models.CASCADE, related_name="consents")
...
class OAuthToken(models.Model):
    ...
    user = models.OneToOneField(TelegramUser, on_delete=models.CASCADE, related_name="bank_oauth")
...
class BankAccount(models.Model):
    ...
    user = models.ForeignKey(TelegramUser, on_delete=models.CASCADE, related_name="bank_accounts")
    ...
    last_balance = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True)
