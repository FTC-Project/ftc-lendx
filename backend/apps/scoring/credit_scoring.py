...
def label_data(transactions):
    ...
    transactions["transaction_direction"] = transactions["amount"].apply(
...
def calculate_transaction_volume(transactions, time_window=6):
    ...
    return (
        average_volume[average_volume.index == "Incoming"].values[0],
        average_volume[average_volume.index == "Outgoing"].values[0],
    )
...
def calculate_transaction_frequency(transactions, time_window=6):
    ...
    return (
        transaction_frequency[transaction_frequency.index == "Incoming"].values[0],
        transaction_frequency[transaction_frequency.index == "Outgoing"].values[0],
    )
...
def calculate_average_transaction_amount(transactions, time_window=6):
    ...
    average_frequency = transactions_grouped.groupby("transaction_direction")[
        "amount"
    ].mean()

    return (
        average_frequency[average_frequency.index == "Incoming"].values[0],
        average_frequency[average_frequency.index == "Outgoing"].values[0],
    )
...
def calculate_average_transaction_variance(transactions, time_window=6):
    ...
    return (
        average_variance[average_variance.index == "Incoming"].values[0],
        average_variance[average_variance.index == "Outgoing"].values[0],
    )
